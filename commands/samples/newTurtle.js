...
class SampleCommand extends RateLimitedTwitchChatCommand {
  ...
  async delayRun(msg) {
    const messages = [
      '給剛來的新觀眾了解這台的規則(基本上沒有)，黑龜=被送訂閱的減重，白龜=被送兩個月的減重，如果你是黑白龜請自覺的禁言自己，有顏色的龜才有話語權',
      '給剛來的觀眾了解這台的規則，基本上這台不會有新觀眾，黑龜=被送訂閱的⚔️🌱，白龜=連續被送兩個月的⚔️🌱，如果你是黑白龜請自覺的禁言自己，有顏色的龜才有話語權',
      '麻煩請遵守聊天室守則，黑白🐢 是禁止發言的，維持良好聊天風氣人人有責 Twitch 󠀀',
      '📢 好消息！📢 好消息！📢 特大好消息！黑白🐢不要打字 peepoStop',
      '⚠️注意 收到免費的訂閱有可能會讓您成為 黑白🐢 成為聊天室最低下的階級',
      '⚠️2023/4/12 黑白🐢之亂 是龜狗聊天室歷史上的大規模民變',
      '歡迎新觀眾！這裡沒有很多規則，但是有一點需要提醒：⚫龜=被送訂閱的減重，⚪龜=被送連續兩個月的減重。如果您是⚫⚪🐢，請自覺禁言自己，有顏色的龜才有話語權。',
      '給新觀眾的提醒：黑龜=被送訂閱的減重，白龜=被送連續兩個月的減重。⚫⚪🐢不需要打字，如果您是黑白龜，讓其他有顏色的龜能夠發言。',
